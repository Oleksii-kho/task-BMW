...
import org.example.service.http.HttpLoader;
...
public class Main {
    ...
    final static private String URL = "jdbc:postgresql://localhost:5432/bmw_test";
    ...
    private static boolean checkCountOfUsers() {
        ...
        if (!firstAttemptToLoad.isPresent() || !secondAttemptToLoad.isPresent()) {
            return false;
        }
        try {
